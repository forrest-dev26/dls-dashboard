// DLS project dashboard — ported from the original root page.
      ...
      <main className="px-8 pt-7 pb-10 max-w-[1400px] max-[1100px]:px-4">
        ...
        <section className="grid grid-cols-6 gap-3 max-[1100px]:grid-cols-3 max-[700px]:grid-cols-2">
          <KpiTile
            ...
            deltaTone={cacDeltaVsTarget !== null && cacDeltaVsTarget <= 0 ? "good" : "bad"}
          />
          <KpiTile
            label="Yesterday CAC"
            ...
            deltaTone={cacDeltaYesterdayVs7d !== null && cacDeltaYesterdayVs7d <= 0 ? "good" : "bad"}
          />
          <KpiTile
            label="New orders · 7d"
        ...
        <section className="mt-8">
          <ProposalList
            project="dls"
            title="Sarah's DLS Proposals"
            emptyText="No pending DLS proposals."
          />
        </section>

        <footer className="mt-10 text-center text-[11px] text-ink-3">
          Dead Letter Studio · Owner Dashboard · live data ·{" "}
